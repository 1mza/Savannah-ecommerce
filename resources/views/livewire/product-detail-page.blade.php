    ...
    <section class="overflow-hidden bg-white py-11 font-poppins dark:bg-gray-800">
        <div class="max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">
            <div class="flex flex-wrap -mx-4">
                <div class="w-full mb-8 md:w-1/2 md:mb-0" x-data="{ mainImage: '{{asset($product->images[0])}}' }">
                    <div class="sticky top-0 z-50 overflow-hidden ">
                        <div class="relative mb-6 lg:mb-10 lg:h-2/4 ">
                            <img x-bind:src="mainImage" alt=""
                                 class="max-w-[900px] max-h-[700px] object-cover w-full lg:h-full ">
                        </div>
                        <div class="flex-wrap hidden md:flex ">
                            @foreach($product->images as $key => $value)
                                <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='{{asset($value)}}'">
...
{{--                                <span class="text-base font-normal text-gray-500 line-through dark:text-gray-400">$1800.99</span>--}}
                        ...
                        <div class="w-32 mb-8 ">
                            ...
                            <div class="relative flex flex-row w-full h-10 mt-6 bg-transparent rounded-lg">
                                ...
                                <input wire:model.live="quantity" type="number" readonly
