    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mt-5">
        ...
        @php
            ...
            if ($order->payment_status=='paid'){
                ...
                $payment_status = '<span class="bg-orange-500 py-1 px-3 rounded text-white shadow">Pending</span>';
            }
                    ...
                    <tr wire:key="{{$item->id}}">
                        <td class="py-4">
                            <div class="flex items-center">
                                <img class="h-16 w-16 mr-4" src="{{asset($item->product->images[0])}}" alt="Product image">
        ...
        <div class="md:w-1/4">
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="flex justify-between mb-2">
                    <span>Subtotal</span>
                    <span>{{Number::currency($item->order->grand_total,'EGP')}}</span>
                </div>
                <div class="flex justify-between mb-2">
                    <span>Taxes</span>
                ...
                <div class="flex justify-between mb-2">
                    ...
                    <span class="font-semibold">{{Number::currency($item->order->grand_total,'EGP')}}</span>
                </div>
