            ...
            <div class="flex flex-wrap mb-24 -mx-3">
                <div class="w-full pr-2 lg:w-1/4 lg:block">
                            ...
                            @foreach($categories as $category)
                                <li class="mb-4" wire:key="{{$category->id}}">
                                    <label for="{{$category->slug}}" class="flex items-center dark:text-gray-400 ">
                                        <input wire:model.live="selectedCategories" type="checkbox"
                            ...
                            @foreach($brands as $brand)
                                <li class="mb-4" wire:key="{{$brand->id}}">
                                    <label for="{{$brand->slug}}" class="flex items-center dark:text-gray-300">
                                        <input wire:model.live="selectedBrands" type="checkbox" id="{{$brand->slug}}"
                        ...
                        <ul>
                            <li class="mb-4">
                                <label for="featured" class="flex items-center dark:text-gray-300">
                                    <input wire:model.live="featured" type="checkbox" id="featured" value="1"
                                           class="w-4 h-4 mr-2">
                            ...
                            <li class="mb-4">
                                <label for="onSale" class="flex items-center dark:text-gray-300">
                                    <input wire:model.live="onSale" type="checkbox" id="onSale" value="1"
                                           class="w-4 h-4 mr-2">
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
                        <div class="">
                            <div class="justify-center text-lg font-bold text-blue-500 ">
                                {{Number::currency($priceRange,'EGP')}}
                            </div>
                            <input wire:model.live="priceRange"
                                   type="range"
                                   class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer"
                                   max="100000" value="10000" step="1000">
                            <div class="flex justify-between ">
                                <span class="inline-block text-lg font-bold text-blue-400 ">{{Number::currency(1000,'EGP')}}</span>
                                <span class="inline-block text-lg font-bold text-blue-400 ">{{Number::currency(100000,'EGP')}}</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="px-3 mb-4">
                        <div class="items-center justify-between hidden px-3 py-2 bg-gray-100 md:flex dark:bg-gray-900 ">
                            <div class="flex items-center justify-between">
                                <select wire:model.live="sortSelection" name="sort" id=""
                            ...
                            <div wire:key="{{$product->id}}" class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3">
                                <div class="border border-gray-300 dark:border-gray-700">
                                    ...
                                    <div class="p-3 ">
                                        ...
                                        <p class="text-lg ">
                                            <span class="text-blue-600 dark:text-green-600">{{Number::currency($product->price,'EGP')}}</span>
                                        </p>
                                    </div>
